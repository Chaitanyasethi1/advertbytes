...
const Skiper39 = () => {
  return (
    <div className="relative h-[250px] sm:h-[350px] w-full bg-[#0A0A0C] text-white overflow-hidden border-t border-gray-800/60">
      <div className="absolute top-6 left-1/2 -translate-x-1/2 z-10 text-center">
        <span className="text-[10px] uppercase tracking-[0.3em] text-[#FFB800] font-bold">
          Crowd Canvas
        </span>
      </div>
