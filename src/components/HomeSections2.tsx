    ...
    <section className="bg-white py-24 sm:py-32 border-t border-gray-100">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 gap-6">
          ...
          <button className="flex items-center gap-2 text-sm font-bold text-[#0A0A0C] hover:text-[#0052FF] transition-colors uppercase tracking-widest">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((svc, i) => (
            <div key={i} className="group bg-[#FBFBFB] border border-gray-100 p-8 rounded-3xl hover:bg-white hover:shadow-xl hover:border-gray-200 transition-all cursor-pointer flex flex-col justify-between h-64">
              <div>
                <h3 className="text-xl font-bold text-[#0A0A0C] mb-3">{svc.title}</h3>
    ...
    <section className="bg-white py-24 border-t border-gray-100 overflow-hidden">
      ...
      <div className="flex gap-8 items-center animate-scroll opacity-50 hover:opacity-100 transition-opacity">
        {[...CLIENT_LOGOS, ...CLIENT_LOGOS].map((logo, i) => (
          <span key={i} className="text-2xl font-black text-gray-900 whitespace-nowrap px-8">
            {logo.label}
          </span>
        ))}
      </div>
...
export const ComparisonSection = () => {
  return (
    <section className="bg-[#FBFBFB] py-24 sm:py-32">
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 rounded-3xl overflow-hidden border border-gray-200 shadow-xl">
          ...
          <div className="bg-white p-10 md:p-16">
            <h3 className="text-2xl font-bold text-[#0A0A0C] mb-8">Typical Agency</h3>
            <ul className="space-y-6 text-gray-600">
              <li className="flex gap-3"><span className="text-gray-300">—</span> Jumps straight into running ads</li>
              <li className="flex gap-3"><span className="text-gray-300">—</span> Creative for the sake of looking good</li>
              <li className="flex gap-3"><span className="text-gray-300">—</span> Reports vanity metrics like likes and impressions</li>
              <li className="flex gap-3"><span className="text-gray-300">—</span> Confusing reports, unclear next steps</li>
              <li className="flex gap-3"><span className="text-gray-300">—</span> Pre-built, one-size-fits-all playbooks</li>
            </ul>
          </div>
        </div>
      </div>
  ...
  return (
    <section className="bg-white py-24 sm:py-32 border-t border-gray-100">
      <div className="max-w-7xl mx-auto px-6 text-center">
        ...
        <div className="bg-[#FBFBFB] border border-gray-200 rounded-3xl p-12 max-w-4xl mx-auto border-dashed">
          <p className="text-xl text-gray-500 italic">
            [ Placeholder for real client testimonials ]<br/>
            <span className="text-sm not-italic mt-4 block text-gray-400">Real quotes will be inserted here upon client approval to maintain 100% authenticity.</span>
          </p>
        </div>
      </div>
    </section>
...
export const FinalCTA = () => {
  return (
    <section className="bg-[#FBFBFB] py-32 border-t border-gray-200 text-center">
      <div className="max-w-4xl mx-auto px-6">
        <h2 className="text-5xl md:text-7xl font-black text-[#0A0A0C] tracking-tighter mb-6">
        ...
        <button className="rounded-full bg-[#0052FF] px-10 py-5 text-sm font-bold text-white hover:bg-[#0052FF]/90 transition-all inline-flex items-center gap-3">
...
export const Footer = () => {
  return (
    <footer className="bg-[#0A0A0C] pt-24 pb-12">
